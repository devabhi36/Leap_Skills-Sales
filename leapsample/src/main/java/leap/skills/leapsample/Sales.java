...
public class Sales extends Activity {
    ...
    public static String token, title2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TableLayout tb = (TableLayout) findViewById(R.id.tabv);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    for (int j = 0; j < students.length(); j++) {
                        ...
                        TextView tv3 = new TextView(Sales.this);
                        ...
                        TextView tv4 = new TextView(Sales.this);
                        ...
                        TextView tv5 = new TextView(Sales.this);
                        ...
                        TextView tv6 = new TextView(Sales.this);
                        ...
                        TextView tv7 = new TextView(Sales.this);
                        ...
                        TextView tv8 = new TextView(Sales.this);
                        ...
                        TextView tv9 = new TextView(Sales.this);
                        ...
                        TextView tv10 = new TextView(Sales.this);
                        ...
                        row1[j].setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                if (v instanceof TableRow) {
                                    ...
                                    // Toast.LENGTH_SHORT);
                                    // toast.show();
                                    ShowTask.stu_id = child0.getText().toString();
                                    ShowTask.name = child1.getText().toString();
                                    ShowTask.email = child2.getText().toString();
                                    ShowTask.phone = child3.getText().toString();
                                    ShowTask.token = token;
                                    Intent intent = new Intent(Sales.this, ShowTask.class);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(Sales.this, error.toString(), Toast.LENGTH_LONG).show();
                if(internet == false) {
                    progressDialog.dismiss();
                    Toast.makeText(Sales.this, "Please Check your internet connection!", Toast.LENGTH_LONG).show();
                }
            }
        }){
        ...
        jsonObjectRequest.setRetryPolicy(new RetryPolicy() {
            ...
            public void retry(VolleyError error) throws VolleyError {
                Toast.makeText(Sales.this, "Slow Internet Connection", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void fill_form(View v1){
        Intent intent = new Intent(this, Lead.class);
        startActivity(intent);
    }

    public void logout_in(View v){
