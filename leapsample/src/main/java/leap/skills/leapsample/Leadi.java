...
public class Leadi extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_leadi);
        ...
        tv5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(Leadi.this, android.R.style.Theme_Holo_Light_Dialog_MinWidth, onDateSetListener, year, month, day);
        ...
        tv6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(Leadi.this, android.R.style.Theme_Holo_Light_Dialog_MinWidth, new TimePickerDialog.OnTimeSetListener() {
                    @Override
        ...
        requestQueue = Volley.newRequestQueue(Leadi.this);
        progressDialog = new ProgressDialog(Leadi.this);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                RequestQueue queue  = Volley.newRequestQueue(Leadi.this);
                JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, url, params,
                        new Response.Listener<JSONObject>() {
                            ...
                            public void onResponse(JSONObject response) {
                                ...
                                Toast.makeText(Leadi.this, "Successfully Inserted", Toast.LENGTH_SHORT).show();

                                Intent i = new Intent(Leadi.this, InternTask.class);
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(Leadi.this, error.toString(), Toast.LENGTH_LONG).show();
                    }
                });
                jsonObjectRequest.setRetryPolicy(new RetryPolicy() {
                    ...
                    public void retry(VolleyError error) throws VolleyError {
                        Toast.makeText(Leadi.this, "Slow Internet Connection", Toast.LENGTH_SHORT).show();
                    }
                });
