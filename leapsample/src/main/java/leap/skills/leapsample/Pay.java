...
public class Pay extends Activity {
        ...
        tselected.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(selected.equals("CP")){
                    Toast.makeText(Pay.this, "Product Selected By You is CP", Toast.LENGTH_SHORT).show();
    ...
    public void submit_payment(View view){
        progressDialog.show();
        ...
        JsonObjectRequest jsonObjectRequest5 = new JsonObjectRequest(Request.Method.POST, url1, params, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                Toast.makeText(Pay.this, "SUCCESSFULLY SUBMITTED BY TRAINER", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(Pay.this, Sales.class);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if(internet == false) {
                    progressDialog.dismiss();
                    Toast.makeText(Pay.this, "Please Check your internet connection!", Toast.LENGTH_LONG).show();
                }
            }
        }){
            @Override
        ...
        jsonObjectRequest5.setRetryPolicy(new RetryPolicy() {
            ...
            public void retry(VolleyError error) throws VolleyError {
                Toast.makeText(Pay.this, "Slow Internet Connection", Toast.LENGTH_SHORT).show();
            }
        });
